...
export type CodeCountry = 'ar' | 'br';

export type BlankLayoutProps = {
  children: ReactNode;
};

export type MobileAppLayoutProps = {
  children: ReactNode;
};
...
export type VerticalNavItemsType = (NavLink | NavGroup | NavSectionTitle | NavSectionSpace)[];
