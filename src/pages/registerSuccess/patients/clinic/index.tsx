...
const RegisterSuccessPatientsClinic = () => {
  // ** Hooks
  ...
  return (
    <>
              ...
              <Grid item xs={12} md={9} sx={{ mr: 20 }}>
                ...
                <Grid xs={12} md={9}>
                  <Typography sx={{ color: 'text.secondary' }}>
                    <Typography style={{ fontWeight: 'bold' }}>Para finalizar tu solicitud,</Typography>
                    ¿quisieras agendar ahora mismo una entrevista con uno de nuestros especialistas?
                  </Typography>
                </Grid>
              </Grid>
      ...
      <InlineWidget url='https://calendly.com/d/dsf-s6m-y6s/turno-de-admision' />
    </>
  );
};

RegisterSuccessPatientsClinic.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>;

RegisterSuccessPatientsClinic.guestGuard = true;

export default RegisterSuccessPatientsClinic;
