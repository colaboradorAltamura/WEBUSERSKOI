...
RegisterTerapeutsCare.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>;

RegisterTerapeutsCare.guestGuard = true;

export default RegisterTerapeutsCare;
