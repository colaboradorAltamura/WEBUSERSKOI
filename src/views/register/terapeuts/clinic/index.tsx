              ...
              {({ values, errors, touched, isSubmitting, setValues }) => (
                <Form id={'registerForm'} autoComplete='off'>
                        ...
                        {loadingOptions ? (
                          ...
                          <CustomTextField
                            ...
                            onChange={(e) =>
                              setValues({
                                ...values,
                                profession: e.target.value as WorkerProfessionTypes,
                              })
                            }
                          >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
                    ...
                    <Typography href={`/login/clinic`} component={LinkStyled}>
                      Login
                    </Typography>
                  </Box>
                </Form>
...
RegisterTerapeutsClinic.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>;

RegisterTerapeutsClinic.guestGuard = true;

export default RegisterTerapeutsClinic;
