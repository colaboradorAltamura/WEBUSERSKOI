...
interface PropsType {
  initialData?: IAvailabilityWeek[];
  onItineraryUpdate: (itinerary: IAvailabilityWeek[]) => void;
}

const ConfigureItineraryModal = ({ initialData, onItineraryUpdate }: PropsType) => {
  // ** Hooks
  ...
  const [availabilityWeek, setAvailabilityWeek] = useState<IAvailabilityWeek[]>(initialData ? initialData : []);
  ...
  const handleOnCancelEdit = () => {
    setAvailabilityWeek(initialData || []);
    setKey(key + 1);
    setEdit(false);
  };
...
export default ConfigureItineraryModal;
