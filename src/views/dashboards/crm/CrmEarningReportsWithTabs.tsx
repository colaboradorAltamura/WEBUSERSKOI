...
type TabCategory = 'processed' | 'initial' | 'interview' | 'clinic';
...
const tabData: TabType[] = [
  {
    ...
    series: [{ data: [28, 10, 45, 38, 15, 0, 0, 0, 0, 0, 0, 0] }],
  },
  {
    type: 'initial',
  ...
  {
    type: 'clinic',
    avatarIcon: 'tabler:medical-cross',
    series: [{ data: [28, 10, 45, 38, 15, 0, 0, 0, 0, 0, 0, 0] }],
  },
];
...
const CrmEarningReportsWithTabs = () => {
  // ** State
  const [value, setValue] = useState<TabCategory>('processed');
  ...
  return (
    <Card>
      <CardHeader
        title='Leads by status over months'
