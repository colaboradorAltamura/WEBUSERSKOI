...
const WidgetOldestPendingPatients = () => {
    ...
    const doAsync = async () => {
      try {
        const response = (await dynamicGet({
          params: '/cms/' + 'applicants',
          filters: [
            {
              key: 'applicantStateType',
              value: [
        ...
        const dataToRender: IApplicantRow[] = [];

        // const statusColors: any = {
        //   ApplicantsStateTypes.: 'info',
        //   'Pending Interview': 'warning',
        //   Rejected: 'error',
        // };
        console.log(finalList);
        // Recorro la lista de applicants para guardar el status y el color de cada estado
        finalList.forEach((applicant: IApplicant) => {
          const statusName = getSourceEntityData({ obj: applicant, key: 'applicantStateType' }).name;

          let statusColor: ThemeColor = 'info';

          if (applicant.applicantStateType === ApplicantsStateTypes.PENDING_INTERVIEW) statusColor = 'warning';
          else if (applicant.applicantStateType === ApplicantsStateTypes.QUOTATION_APPROVED) statusColor = 'success';
          else if (applicant.applicantStateType === ApplicantsStateTypes.PENDING_QUOTATION) statusColor = 'info';

          const applicantRow: IApplicantRow = { ...applicant, statusName: t(statusName), statusColor };

          dataToRender.push(applicantRow);
        });
  ...
  return (
    ...
    >
      <CardHeader
        title={t('Oldest open applications')}
...
export default WidgetOldestPendingPatients;
