...
const SummaryTab = ({
  ...
  const [companyData, setCompanyData] = useState<ICompany>(companyDataArg);
          ...
          <CardContent>
            <Grid container spacing={4}>
              <Grid item xs={12} md={6}>
                ...
                <TextInfo title={'taxCondition'} value={companyData.taxCondition}></TextInfo>
                <TextInfo title={'address'} value={companyData.address}></TextInfo>
                <TextInfo title={'monthlyReport'} value={companyData.monthlyReport}></TextInfo>
                <TextInfo title={'companyIdentificationNumber'} value={companyData.identificationNumber}></TextInfo>
              </Grid>
              {/* <Grid item xs={12} md={6}>
