...
import { IApplicant, ICompany, IHealthInsuranceAgreement } from 'src/types/@autogenerated';
...
interface PropsType {
  ...
  companyDataArg: IHealthInsuranceAgreement;
...
const SummaryTab = ({
  ...
  const [companyData, setCompanyData] = useState<IHealthInsuranceAgreement>(companyDataArg);
  ...
  const handleOnEntityEdit_Company = () => {
    try {
      ...
      const fieldsNames = ['name', 'hourlyRateEnlite', 'validFrom', 'weeklyHoursMax', 'agreementState', 'validUntil'];
          ...
          <CardContent>
            <Grid container spacing={4}>
              <Grid item xs={12} md={6}>
                <TextInfo title={'businessName'} value={companyData.name}></TextInfo>
                <TextInfo title={'rate enlite'} value={`$ ${companyData.hourlyRateEnlite} / hora`}></TextInfo>
                <TextInfo title={'valid from'} value={formatDate(companyData.validFrom)}></TextInfo>
                <TextInfo title={'weekly hours max'} value={companyData.weeklyHoursMax}></TextInfo>
                <TextInfo title={'status'} value={companyData.agreementState}></TextInfo>
                <TextInfo title={'valid until'} value={formatDate(companyData.validUntil)}></TextInfo>
              </Grid>
              {/* <Grid item xs={12} md={6}>
